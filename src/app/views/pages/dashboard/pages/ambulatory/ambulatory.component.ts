...
@Component({
  selector: 'kt-ambulatory',
  templateUrl: './ambulatory.component.html',
  styleUrls: ['./ambulatory.component.scss']
})
export class AmbulatoryComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
	this.SubHeaderService.setTitle('ambu');
	this.initChart();
