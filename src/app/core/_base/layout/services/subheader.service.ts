...
export class SubheaderService {
	// Public properties
	action$: BehaviorSubject<() => void> = new BehaviorSubject<() => void>(null);
	...
	getConsultationPDF(consultationID) {
		return this.http.get<GetPDFResponse>(`${environment.apiEndpoint}/consultations/getPDF/` + consultationID);
	}
}
